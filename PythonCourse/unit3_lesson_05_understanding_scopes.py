...
-scopes of variables global and local
-scope of global and how they can be writed
-learnt about NameError which raises on assigning variables before their initializtion
"""

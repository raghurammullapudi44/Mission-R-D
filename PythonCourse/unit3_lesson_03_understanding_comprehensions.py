...
-what are comprehensions,how are they implemented to reduce the code to one liners
-i had used earlier but i donot know them then,for converting integer list into string as ''.join(str(x) for x in a)
-how to optimze a code using comprehensions and how they can be used as an alternative for maps and filters and many,,,,
"""

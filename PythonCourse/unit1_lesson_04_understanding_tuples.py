...
def test_tuple_unpacking():
    ...
    try:
        ...
        print ve  # observe what is printed here.#"too many values to unpack" is printed
        assert True
...
def min_max(input):
    ...
    """
    return (input[0],input[-1])  # write a line of code to return containing min and max

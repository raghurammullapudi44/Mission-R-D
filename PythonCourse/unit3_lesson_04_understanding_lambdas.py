...
-firstly what is an lambda function
-how it can be used and how it can be passed as an arguments to higher order functions to invoke them there and return their results
-and how the parameters of the higher order function changed in 4 th function(please again refer it), how the higher order functions are refernced and then invoked
"""
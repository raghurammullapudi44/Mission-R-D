...
def test_classes_bound_and_unbound_methods():
    ...
    assert q1.push.__self__ != TestQueue.push.__self__   #unbound method
...
class Person(object):
    ...
    def get_bmi_result(self):
        bmi=(self.weight)/((0.3048*self.height)**2)
...
-what are classes and how they can be created and used in programming
-and how the instances of classes are created and how they operated by various bound and unbound concepts
-to write and implement my first code using classes
"""
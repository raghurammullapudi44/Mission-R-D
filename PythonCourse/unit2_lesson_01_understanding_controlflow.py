...
-how to use control flow statements syntaxes
-how they are used in programming
-learnt about why they are not prefered if there are any built in functions to do the same task(declarative programming)
"""
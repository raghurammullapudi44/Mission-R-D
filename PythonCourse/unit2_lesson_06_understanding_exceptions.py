...
-exception handling which is common to most object oriented languages like JAVA
-how can be an exception handled, when an exception is handled in one function,the function which calls it need not again handle it there
-finally block is executed always,but else block executes only when there is no exception which is to be handled
"""

...
def test_package_import_failure():
    ...
    #why_it_failed = In the filesystem a directory containing __init__.py
    #is treated as a package when python tries to find packages on sys.path.
...
def test_package_sub_packages():
    ...
    print subpackage.m1.__doc__   #because we had alreday imported subpackage of package1,subpackage itself is a package and it returns none

    assert True == ("package1.subpackage.m1" in sys.modules)

three_things_i_learnt = """
-about modules in  more detail and the packages ,,,
-how to clear sys.modules and importing of packages and sub packages
-about the scope imported packages in locals and globals  and also in sys.modules
"""
